...
public class RememberPassword extends Activity{
	...
	public boolean guardarCreditos(String newTotalCreditos,String usuario) throws JSONException{
		ArrayList<NameValuePair> postparameters2send= new ArrayList<NameValuePair>();
  		...
  		Log.e("inscribirPrivadas","url_connect1= "+URL_connect);
  		jdata= post.getserverdata(postparameters2send, URL_connect);
    ...
    public void err_info(){
    	Vibrator vibrator =(Vibrator) getSystemService(Context.VIBRATOR_SERVICE);
	    vibrator.vibrate(200);
	    Toast toast1 = Toast.makeText(getApplicationContext(),"Error:Error al mostrar la pregunta", Toast.LENGTH_SHORT);
 	    toast1.show();    	
    }
